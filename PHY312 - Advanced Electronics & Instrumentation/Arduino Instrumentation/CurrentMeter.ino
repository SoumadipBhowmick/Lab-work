// Connect A2 between Load and Resistor.

// Select the resistance R around 1% or less than the load resistance. 

// This can measure few milli amperes or may be upto 100 mA.
